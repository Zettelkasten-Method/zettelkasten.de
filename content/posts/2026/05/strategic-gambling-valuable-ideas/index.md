...
1. **Aphorism.** A small text, containing just a few sentences **to point to an idea**,<!--TODO: link to "point to idea" post when released --> rarely, perhaps never, expressing the idea fully.
