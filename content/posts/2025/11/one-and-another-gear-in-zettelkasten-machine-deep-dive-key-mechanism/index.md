---
title: "One (and another) Gear in the Zettelkasten Machine: A Deep Dive into a Key Mechanism"
created_at: 2025-11-26 17:21:01 +0100
kind: article
author: "sascha"
tags: [ iceberg, toolbox,  ]
rel_image: ./gears.jpg
vgwort: https://vg02.met.vgwort.de/na/348ba4666f68471c8b63f3bc4c43b426
description: "Each element of your workflow has a specific effect. You might compare it to key training sessions like explosive strength training or circuit training. Together they make (or break) your practice."
---
This piece has two goals:

1. Provide a tool to assess the benefits of various methods and tools for writing and thinking.
2. A deeper dive into the iceberg of the Zettelkasten Method.

## There are distinct but interconnected chains of cause and effect within each method.

<%= insert_teaser caption: %Q{Image by <a href="https://unsplash.com/de/@viazavier">Laura Ockel</a> on <a href="https://unsplash.com/de/fotos/goldenes-und-silbernes-rundes-accessoire-UQ2Fw_9oApU">Unsplash</a>} %>
...
Longer sessions improve the ratio of warming up to deep work.[^20250217managermaker]

[^20250217managermaker]:   [http://www.paulgraham.com/makersschedule.html](http://www.paulgraham.com/makersschedule.html)

Shorter and more frequent sessions waste more time per session to warm you up.

<%= insert_rel_image file: "./session.png" %>
...
That doesn't mean that a combination cannot be beneficial to somebody. A Commonplace Book, especially the handwritten ones, adds a lot of scholarly aesthetics to your work. Just take a look at the beautiful [notebook collection of Leonardo da Vinci](https://www.openculture.com/2021/05/where-to-read-leonardo-da-vincis-notebooks-online.html). After years of that practice, you'll have a diary and a biography of your intellectual development, and a tool for nostalgia. I, thank you for asking, am not interested in any nostalgia in my life. I threw away all my diaries and notebooks. But you might have different inclinations.
...
The identification of chains of cause and effect is one of the cornerstones of the Zettelkasten Method: [Each Step in the Process Must Be Knowledge-Based Value Creation](https://zettelkasten.de/posts/every-step-value-creation/). My goal is to create a set of principles, methods, and techniques that are optimised for value creation.
...
Adhering to the [principle of atomicity](https://zettelkasten.de/atomicity/) builds a habit of distilling ideas to their essence. One tool for atomising the ideas you think about is [the inventory of knowledge building blocks](https://zettelkasten.de/atomicity/guide/#what-is-atomicity).
...
1. A deeper analytical understanding of the ideas you are working with.[^20250217analy]
2. Atomic notes, if you practice atomisation in written form.

[The Zettelkasten Method shouldn't add anything to your schedule](https://forum.zettelkasten.de/discussion/2825/the-zettelkasten-shouldnt-add-anything-to-your-schedule). It instead restructures and reallocates the individual steps of your knowledge work. The same is true for the atomisation of ideas. It should be part of any knowledge work practice. It is that powerful.

[^20250217analy]: I am explicitly writing analytical understanding, because connecting ideas gives you a synthetic understanding. One is achieved by breaking the whole into parts; the other is achieved by bringing ideas together into a larger whole and identifying connections.
...
> ---[Luhmann](https://zettelkasten.de/communications-with-zettelkastens/)
